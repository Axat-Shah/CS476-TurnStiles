...
<br>		<div class="container">
				<h2 class="title text-center">Beds</h2><br /><br />
			<?php
			...
			<div class="col-md-4">
				<form method="post" action="index.php?action=add&id=<?php echo $row["product_id"]; ?>">
					<div style="border:1px solid #F7F7F5; overflow: hidden; margin-bottom:30px; position: relative; color: #FE980F; font-family: 'Roboto', sans-serif; font-size: 24px; font-weight: 700;" align="center" >
						<br>
						<div class="flip-card">
